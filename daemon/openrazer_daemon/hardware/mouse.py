...
class RazerLanceheadWireless(__RazerDeviceSpecialBrightnessSuspend):
    """
    ...
    METHODS = ['get_device_type_mouse', 'max_dpi', 'get_dpi_xy', 'set_dpi_xy', 'get_poll_rate', 'set_poll_rate', 'get_logo_brightness', 'set_logo_brightness', 'get_scroll_brightness', 'set_scroll_brightness',
               ...
               # Battery
               'get_battery', 'is_charging', 'set_charge_effect', 'set_charge_colour', 'set_idle_time', 'set_low_battery_threshold',
               # Logo
